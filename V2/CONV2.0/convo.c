 ...
 ****/
short IzToLayer(short Iz, InStru *In_Ptr)
{
 ...
 ****/
void A_rzFromA_rzt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, iz, it;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void Ab_zFromAb_zt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short iz, it;
    short nz = In_Ptr->nz;
    short nt = In_Ptr->nt;
 ...
 ****/
void A_ztFromA_rzt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, iz, it;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void A_zFromA_rzt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, iz, it;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
    ...
    for (iz = 0; iz < nz; iz++) {
        ...
        for (it = 0; it < nt; it++) {
            for (ir = 0; ir < nr; ir++)
                Out_Ptr->A_z[iz] += Out_Ptr->A_rzt[ir][iz][it] * dt * 2.0 * PI * (ir + 0.5) * dr * dr;
 ...
 ****/
void A_zFromA_rz(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, iz;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void A_zFromA_zt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short iz, it;
    short nz = In_Ptr->nz;
    short nt = In_Ptr->nt;
 ...
 ****/
void A_tFromA_rzt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, iz, it;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void A_tFromA_zt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short iz, it;
    short nz = In_Ptr->nz;
    short nt = In_Ptr->nt;
 ...
 ****/
void Rd_raFromRd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Rd_rtFromRd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Rd_atFromRd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Rd_rFromRd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
    ...
    for (ir = 0; ir < nr; ir++) {
        ...
        for (ia = 0; ia < na; ia++)
            for (it = 0; it < nt; it++)
                Out_Ptr->Rd_r[ir] += Out_Ptr->Rd_rat[ir][ia][it] * dt * PI * sin(2.0 * (ia + 0.5) * da) * da;
    }
}
 ...
 ****/
void Rd_rFromRd_ra(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Rd_rFromRd_rt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, it;
    short nr = In_Ptr->nr;
    short nt = In_Ptr->nt;
 ...
 ****/
void Rd_aFromRd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
    ...
    for (ia = 0; ia < na; ia++) {
        ...
        for (ir = 0; ir < nr; ir++)
            for (it = 0; it < nt; it++)
                Out_Ptr->Rd_a[ia] += Out_Ptr->Rd_rat[ir][ia][it] * dt * 2.0 * PI * (ir + 0.5) * dr * dr;
    }
}
 ...
 ****/
void Rd_aFromRd_ra(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Rd_aFromRd_at(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ia, it;
    short na = In_Ptr->na;
    short nt = In_Ptr->nt;
 ...
 ****/
void Rd_tFromRd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
        ...
        for (ir = 0; ir < nr; ir++)
            for (ia = 0; ia < na; ia++)
                Out_Ptr->Rd_t[it] += Out_Ptr->Rd_rat[ir][ia][it]
                    * 2.0 * PI * (ir + 0.5) * dr * dr * PI * sin(2.0 * (ia + 0.5) * da) * da;
    }
}
 ...
 ****/
void Rd_tFromRd_rt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, it;
    short nr = In_Ptr->nr;
    short nt = In_Ptr->nt;
 ...
 ****/
void Rd_tFromRd_at(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ia, it;
    short na = In_Ptr->na;
    short nt = In_Ptr->nt;
 ...
 ****/
void Td_raFromTd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Td_rtFromTd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Td_atFromTd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Td_rFromTd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
    ...
    for (ir = 0; ir < nr; ir++) {
        ...
        for (ia = 0; ia < na; ia++)
            for (it = 0; it < nt; it++)
                Out_Ptr->Td_r[ir] += Out_Ptr->Td_rat[ir][ia][it] * dt * PI * sin(2.0 * (ia + 0.5) * da) * da;
    }
}
 ...
 ****/
void Td_rFromTd_ra(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Td_rFromTd_rt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, it;
    short nr = In_Ptr->nr;
    short nt = In_Ptr->nt;
 ...
 ****/
void Td_aFromTd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
    ...
    for (ia = 0; ia < na; ia++) {
        ...
        for (ir = 0; ir < nr; ir++)
            for (it = 0; it < nt; it++)
                Out_Ptr->Td_a[ia] += Out_Ptr->Td_rat[ir][ia][it] * dt * 2.0 * PI * (ir + 0.5) * dr * dr;
    }
}
 ...
 ****/
void Td_aFromTd_ra(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Td_aFromTd_at(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ia, it;
    short na = In_Ptr->na;
    short nt = In_Ptr->nt;
 ...
 ****/
void Td_tFromTd_rat(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void Td_tFromTd_rt(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ir, it;
    short nr = In_Ptr->nr;
    short nt = In_Ptr->nt;
 ...
 ****/
void Td_tFromTd_at(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short ia, it;
    short na = In_Ptr->na;
    short nt = In_Ptr->nt;
 ...
 ****/
double IzToMua(short iz, InStru *In_Ptr)
{
 ...
 ****/
void SpecifyBeam(FILE *Fp, ConvStru *Conv_Ptr)
{
 ...
 ****/
double GetFixedTZRA(double Max, char mode)
{
    double number;
    char buf[STRLEN];
 ...
 ****/
void WriteA_rz3Columns(InStru *In_Ptr, double **A_rz, double Pt, char mode)
{
    short ir, iz;
    double r;
    short nr = In_Ptr->nr;
    ...
    fprintf(file, "# %s extracted from %s\n", fname, In_Ptr->out_fname);
    if (mode == 0)
        fprintf(file, "# A_rz at t = %G ps\n", Pt);
    else if (mode == 1)
        fprintf(file, "# F_rz at t = %G ps\n", Pt);
    else if (mode == 2)
        fprintf(file, "# A_rz\n");
    else
        fprintf(file, "# F_rz\n");
    if (mode == 0 || mode == 2)
        fprintf(file, "# %-10s\t%-12s\t%-12s\n", "r [cm]", "z [cm]", "A [1/(cm3 ps)]");
    if (mode == 1 || mode == 3)
        fprintf(file, "# %-10s\t%-12s\t%-12s\n", "r [cm]", "z [cm]", "F [1/(cm2 ps)]");

    for (ir = 0; ir < nr - 1; ir++) {
        r = ((ir + 0.5) + 1 / (12 * (ir + 0.5))) * dr;
        for (iz = 0; iz < nz - 1; iz++)
            fprintf(file, "%-12.4E\t%-12.4E\t%-12.4E\n", r, (iz + 0.5) * dz, A_rz[ir][iz]);
    }
 ...
 ****/
void ExtractA_rz_t(InStru *In_Ptr, OutStru *Out_Ptr, char mode)
{
    short ir, iz, it;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void WriteConvA_rz3Columns(InStru *In_Ptr, ConvStru *Conv_Ptr, double **A_rz, double Pt, char mode)
{
    short ir, iz;
    double r;
    ...
    if (mode == 0)
        ...
        fprintf(file, "# F_rzc\n");
    if (mode == 0 || mode == 2)
        fprintf(file, "# %-10s\t%-12s\t%-12s\n", "r [cm]", "z [cm]", "A [J/(cm3 ps)]");
    if (mode == 1 || mode == 3)
        fprintf(file, "# %-10s\t%-12s\t%-12s\n", "r [cm]", "z [cm]", "F [J/(cm2 ps)]");
 ...
 ****/
void ExtractConvA_rz_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, iz, it;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void ExtractA_rz(InStru *In_Ptr, OutStru *Out_Ptr, char mode)
{
    short ir, iz;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void ExtractConvA_rz(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, iz;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void ExtractA_z_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, iz, it;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void ExtractA_z(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short iz;
    short nz = In_Ptr->nz;
    double dz = In_Ptr->dz;
 ...
 ****/
void ExtractA_t_r_z(InStru *In_Ptr, OutStru *Out_Ptr, char mode)
{
    short ir, iz, it;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void ExtractConvA_t_r_z(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, iz, it;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
...
#if IBMPC == 0
    if (mode == 0)
        strcpy(fname, "At@r@zc");
    else
        strcpy(fname, "Ft@r@zc");
#endif
    if ((file = GetWriteFile(fname)) == NULL)
        return;
 ...
 ****/
void ExtractA_t_z(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, iz, it;
    short nr = In_Ptr->nr;
    short nz = In_Ptr->nz;
 ...
 ****/
void ExtractA_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short it;
    short nt = In_Ptr->nt;
    double dt = In_Ptr->dt;
 ...
 ****/
void ExtractA_l(InStru *In_Ptr, OutStru *Out_Ptr)
{
    short iz, ilayer;
    short nz = In_Ptr->nz;
    short num_layers = In_Ptr->num_layers;
 ...
 ****/
void ExtractRd_r_a_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
...
#if IBMPC == 0
    if (mode == 0)
        strcpy(fname, "Rdr@a@t");
    else
        strcpy(fname, "Rdr@a@tc");
#endif
    if ((file = GetWriteFile(fname)) == NULL)
        return;
 ...
 ****/
void ExtractRd_r_a(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
    ...
    if (((Conv_Ptr->M_rx = AllocArray2D(0, nr - 1, 0, 0, 0)) == NULL)
        || ((mode == 1) && (Rd_rxc = AllocArray2D(0, Conv_Ptr->nrc - 1, 0, 0, 0)) == NULL)) {
 ...
 ****/
void ExtractRd_r_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void ExtractRd_r(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir;
    short nr = In_Ptr->nr;
    double dr = In_Ptr->dr;
 ...
 ****/
void ExtractRd_a_r_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
...
#if IBMPC == 0
    if (mode == 0)
        strcpy(fname, "Rda@r@t");
    else
        strcpy(fname, "Rda@r@tc");
#endif
    if ((file = GetWriteFile(fname)) == NULL)
        return;
 ...
 ****/
void ExtractRd_a_r(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void ExtractRd_a_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void ExtractRd_a(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ia;
    short na = In_Ptr->na;
    double da = In_Ptr->da;
 ...
 ****/
void ExtractRd_t_r_a(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
...
#if IBMPC == 0
    if (mode == 0)
        strcpy(fname, "Rdt@r@a");
    else
        strcpy(fname, "Rdt@r@ac");
#endif
    if ((file = GetWriteFile(fname)) == NULL)
        return;
 ...
 ****/
void ExtractRd_t_r(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void ExtractRd_t_a(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void ExtractRd_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short it;
    short nt = In_Ptr->nt;
    double dt = In_Ptr->dt;
 ...
 ****/
void ExtractTd_r_a_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
...
#if IBMPC == 0
    if (mode == 0)
        strcpy(fname, "Tdr@a@t");
    else
        strcpy(fname, "Tdr@a@tc");
#endif
    if ((file = GetWriteFile(fname)) == NULL)
        return;
 ...
 ****/
void ExtractTd_r_a(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
    ...
    if (((Conv_Ptr->M_rx = AllocArray2D(0, nr - 1, 0, 0, 0)) == NULL)
        || ((mode == 1) && (Td_rxc = AllocArray2D(0, Conv_Ptr->nrc - 1, 0, 0, 0)) == NULL)) {
 ...
 ****/
void ExtractTd_r_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void ExtractTd_r(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir;
    short nr = In_Ptr->nr;
    double dr = In_Ptr->dr;
 ...
 ****/
void ExtractTd_a_r_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
...
#if IBMPC == 0
    if (mode == 0)
        strcpy(fname, "Tda@r@t");
    else
        strcpy(fname, "Tda@r@tc");
#endif
    if ((file = GetWriteFile(fname)) == NULL)
        return;
 ...
 ****/
void ExtractTd_a_r(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void ExtractTd_a_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void ExtractTd_a(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ia;
    short na = In_Ptr->na;
    double da = In_Ptr->da;
 ...
 ****/
void ExtractTd_t_r_a(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
...
#if IBMPC == 0
    if (mode == 0)
        strcpy(fname, "Tdt@r@a");
    else
        strcpy(fname, "Tdt@r@ac");
#endif
    if ((file = GetWriteFile(fname)) == NULL)
        return;
 ...
 ****/
void ExtractTd_t_r(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void ExtractTd_t_a(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short ir, ia, it;
    short nr = In_Ptr->nr;
    short na = In_Ptr->na;
 ...
 ****/
void ExtractTd_t(InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr, char mode)
{
    short it;
    short nt = In_Ptr->nt;
    double dt = In_Ptr->dt;
 ...
 ****/
void PrintRecordQuan(InStru *In_Ptr)
{
...
void PrintExtractQuan(ConvStru *Conv_Ptr, char mode)
{
    ...
    if (Conv_Ptr->extract.A_t_r_z) {
        PrintAndNewLine(&index, "A_t@r@z");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_rz_t) {
        PrintAndNewLine(&index, "A_rz@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_z_t) {
        PrintAndNewLine(&index, "A_z@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_t_z) {
        PrintAndNewLine(&index, "A_t@z");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_rz) {
        PrintAndNewLine(&index, "A_rz");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_z) {
        PrintAndNewLine(&index, "A_z");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_t) {
        PrintAndNewLine(&index, "A_t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_l && mode == 0) {
        PrintAndNewLine(&index, "A_l");
        needspace = 1;
    }
    ...
    needspace = 0;
    if (Conv_Ptr->extract.A_t_r_z) {
        PrintAndNewLine(&index, "F_t@r@z");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_rz_t) {
        PrintAndNewLine(&index, "F_rz@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_z_t) {
        PrintAndNewLine(&index, "F_z@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_t_z) {
        PrintAndNewLine(&index, "F_t@z");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_rz) {
        PrintAndNewLine(&index, "F_rz");
        needspace = 1;
    }
    if (Conv_Ptr->extract.A_z) {
        PrintAndNewLine(&index, "F_z");
        needspace = 1;
    }
    ...
    if (Conv_Ptr->extract.Rd_r_a_t) {
        PrintAndNewLine(&index, "Rd_r@a@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_a_r_t) {
        PrintAndNewLine(&index, "Rd_a@r@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_t_r_a) {
        PrintAndNewLine(&index, "Rd_t@r@a");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_r_a) {
        PrintAndNewLine(&index, "Rd_r@a");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_r_t) {
        PrintAndNewLine(&index, "Rd_r@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_a_r) {
        PrintAndNewLine(&index, "Rd_a@r");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_a_t) {
        PrintAndNewLine(&index, "Rd_a@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_t_r) {
        PrintAndNewLine(&index, "Rd_t@r");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_t_a) {
        PrintAndNewLine(&index, "Rd_t@a");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_r) {
        PrintAndNewLine(&index, "Rd_r");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_a) {
        PrintAndNewLine(&index, "Rd_a");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Rd_t) {
        PrintAndNewLine(&index, "Rd_t");
        needspace = 1;
    }
    ...
    if (Conv_Ptr->extract.Td_r_a_t) {
        PrintAndNewLine(&index, "Td_r@a@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_a_r_t) {
        PrintAndNewLine(&index, "Td_a@r@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_t_r_a) {
        PrintAndNewLine(&index, "Td_t@r@a");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_r_a) {
        PrintAndNewLine(&index, "Td_r@a");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_r_t) {
        PrintAndNewLine(&index, "Td_r@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_a_r) {
        PrintAndNewLine(&index, "Td_a@r");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_a_t) {
        PrintAndNewLine(&index, "Td_a@t");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_t_r) {
        PrintAndNewLine(&index, "Td_t@r");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_t_a) {
        PrintAndNewLine(&index, "Td_t@a");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_r) {
        PrintAndNewLine(&index, "Td_r");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_a) {
        PrintAndNewLine(&index, "Td_a");
        needspace = 1;
    }
    if (Conv_Ptr->extract.Td_t) {
        PrintAndNewLine(&index, "Td_t");
        needspace = 1;
    }
 ...
 ****/
void BranchOrigQuantity(char *Quantity, InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr)
{
...
/**************************************************************************
 ****/
void BranchConvQuantity(char *Quantity, InStru *In_Ptr, OutStru *Out_Ptr, ConvStru *Conv_Ptr)
{
    if ((strcmp(Quantity, "A_RZ@T") == 0) && Conv_Ptr->extract.A_rz_t)
